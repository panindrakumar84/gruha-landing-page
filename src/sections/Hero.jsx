    ...
    return (
        <section id='home'
            ...
            <div className='max-container flex flex-wrap  md:flex-row items-center justify-center '>
                <div className=" lg:w-1/2 flex flex-col justify-center  lg:justify-start font-poppins mt-16 gap-6    ">

                    <h1 className=' text-heading text-5xl lg:text-7xl font-medium max-w-xl '>
                    ...
                    <div className="w-full flex gap-6 justify-center  lg:justify-start  ">
