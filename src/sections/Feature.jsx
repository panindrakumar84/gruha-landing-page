...
const Feature = () => {
  return (
    ...
    <div className=' max-container flex flex-wrap items-center xl:w-[90%] self-center  justify-center gap-8 max-sm:padding-x '>
    ...
    {/* //* what we offer */}
    <div className='bg-gradient-to-tr from-red-800 to-red-950 '>
    <div className='max-container rounded-md px-8 padding-y flex flex-col flex-wrap items-center justify-evenly lg:flex-row gap-8'> 
      ...
      <div className='max-w-[470px] flex flex-col justify-center items-center gap-8 '>
          ...
          ' >
            ...
            <div >
              <Button label= "Get a demo" backgroundColor="bg-white"/>
            </div>
          </div>
